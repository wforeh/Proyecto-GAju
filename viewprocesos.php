        ...
        <section class="content"><!-- Main content -->
            <div class="row"><!-- Small boxes (Stat box) -->
                ...
                <?php
                    ...
                    $SQL="SELECT * FROM pr_liquidaciones where iduser = ".$_SESSION["user_id"]." and id =".$id;
                    }

                    if($tipo==2){
                 $files = mysqli_query($con,"SELECT * FROM pr_reorganizaciones where iduser = ".$_SESSION["user_id"]." and id =".$id);
                 $SQL="SELECT * FROM pr_reorganizaciones where iduser = ".$_SESSION["user_id"]." and id =".$id;
                    }

                    if($tipo==3){
                    $files = mysqli_query($con,"SELECT * FROM pr_insolvencias where iduser = ".$_SESSION["user_id"]." and id =".$id);
                    $SQL="SELECT * FROM pr_insolvencias where iduser = ".$_SESSION["user_id"]." and id =".$id;
                    }
                ...
                ?>
                    ...
                    <?php else:?>
                       <div class="col-md-6 col-md-offset-3">
                        ...
                        fa fa-exclamation-triangle"></i> No se encontraron Procesos</p>
                       </div>
                    <?php endif;?>
                </div>
            </div><!-- /.row -->
