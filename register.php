...
<head>
    ...
    <title>Gaju v1.0 .:Iniciar Sesion:.</title>
        ...
        <div class="register-box-body">
            ...
            <form method="post" id="add" name="add">
                ...
                <div class="form-group has-feedback">
                    ...
                    <OPTION VALUE="2" value="2">VENDEDOR/COBRADOR
            ...
            <br>
            <a href="home.php" type="submit" class="btn btn-primary btn-block btn-flat">Home</a>
