<?php 
    ...
    $id_externo=$_POST['idexterno'];
    $query=mysqli_query($con,"SELECT * from user where id=$id_externo");
    while ($row=mysqli_fetch_array($query)) {
        $ext_fullname = $row['fullname'];
        $ext_email = $row['email'];
        $ext_profile_pic = $row['image'];
        $ext_created_at = $row['created_at'];
    }
            ...
            <div class="row"><!-- .row -->
                <div class="col-md-4">
                    <div class="image view view-first">
                        <img class="thumb-image" style="width: 100%; display: block;" src="images/profiles/<?php echo $ext_profile_pic ?>"" alt="image">
                    </div>
                ...
                <!-- <div id="result"></div> -->
                    <div class="box box-primary"><!-- general form elements -->
                        ...
                        <form role="form" method="post" action="action/updprofile3.php"><!-- form start -->
                            <div class="box-body">

                               <div class="form-group">
                                    <label for="idexterno">Id</label>
                                    <input name="idexterno" type="text" class="form-control" id="idexterno" value="<?php echo $id_externo ?>" readonly>
                                </div>


                                <div class="form-group">
                                    <label for="fullname">Nombre Completo</label>
                                    <input name="fullname" type="text" class="form-control" id="fullname" value="<?php echo $ext_fullname ?>">
                                </div>
                                <div class="form-group">
                                    <label for="email">Correo Electrónico</label>
                                    <input name="email" type="email" class="form-control" id="email" value="<?php echo $ext_email ?>">
                                </div>
                                <div class="form-group">
