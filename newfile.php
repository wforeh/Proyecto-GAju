                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="box box-primary"><!-- general form elements -->
                        <div class="box-header with-border">
                            <h3 class="box-title"><button class="btn btn-xs btn-success"><i class="fa fa-plus"></i></button> Cargar Nuevo Archivo a Proceso</h3>
                        </div><!-- /.box-header -->
                        ...
                        <form role="form" action="action/addfile.php" method="post" enctype="multipart/form-data"><!-- form start -->
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" placeholder="E.j: archivo camara comercio"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Proceso Destino</label>
                                    <select class="form-control select2" name="folder_id">
                                      <option value="" selected="selected">---Seleciona tu proceso---</option>
