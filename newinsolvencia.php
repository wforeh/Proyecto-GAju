 ...
 ?>
    ...
    <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
        <section class="content-header"><!-- Content Header (Page header) -->
            <h1>Nueva Insolvencia</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Nueva Insolvencia</li>
            </ol>
        </section>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <?php
                        ...
                        if (isset($_GET['success'])) {
                            echo "<p class='alert alert-success'> <i class=' fa fa-exclamation-circle'></i> <strong>¡Bien hecho! </strong> Proceso de Insolvencia creado correctamente.</p>";
                    ...
                    <div class="box box-primary"><!-- general form elements -->
                        ...
                        <form role="form" action="action/addinsolvencia.php" method="post"><!-- form start -->
                            <div class="box-body">

                                <div class="form-group">
                                    <label for="name_folder">Nombre del proceso insolvencia</label>
